...
export const headerData = {
    ...
    title: "Experienced ReactJS Frontend Developer",
    location: "Hyderabad",
    email: "siva.attili123@gmail.com",
...
export const softSkillData = {
    header: "Soft-Skills",
    skills: ["Performance Optimization", "Scalability", "Team Collaboration", "Problem Solving", "Continuous Learning", "Time Management", "Agile Methodology and Scrum Experience"]
}
...
export const experienceData = {
    ...
    Details: [
        ...
        responsibilities: [
            ...
            "Developed the application components using ES6/7, HTML5,CSS3 and Typescript",
    ...
    {
        company: "Print Ideas Pvt Ltd",
        role: "Junior Frontend Developer",
        year: "Nov 2018- Jan2020",
        responsibilities: [
            "Developed and maintained user interfaces using React.js",
            "Learned basics well.",
            "Converted Bootstrap application to css.",
            "Pushing the code to git regular basis.",
